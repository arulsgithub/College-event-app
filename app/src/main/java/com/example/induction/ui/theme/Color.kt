package com.example.induction.ui.theme
...
val blue_bg = Color(0xFF0CA1AF)
val light_bg = Color(0xffd2f0fa)
val hello_blue = Color(0xFF1D87DA)
val DarkGreen = Color(0xFF006120)
val lightblue = Color(0xFFADE0F0)
